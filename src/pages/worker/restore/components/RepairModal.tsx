...
interface RepairModalProps {
  ...
  // 确认更新
  onRepair: (repairModalFormParams: RepairModalFormParams) => void
  // 关闭确认框
  onCancel: () => void
}
...
export default connect(mapStateToProps)(Form.create<RepairModalProps>()(RepairModal))
